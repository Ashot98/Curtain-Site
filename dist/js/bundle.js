...
(0, _jquery2.default)(window).on('resize', function () {
  ...
  var reqCss = (0, _jquery2.default)('.nav .active').css('display');
  var menu = (0, _jquery2.default)('.nav li');
  var logo = (0, _jquery2.default)('.nav .logo');

  if (winSize > 560 && reqCss == 'none') menu.css({
    "display": "block"
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      if (page == 'admin' || page == 'addphoto') return _react2.default.createElement(
        'div',
        null,
        ' ',
        _routes2.default,
...
var renderField = exports.renderField = function renderField(_ref) {
  ...
  var inputClass = touched && error ? 'err_req' : '';
  return _react2.default.createElement(
    'div',
    { className: 'form_item ' + className },
    ...
    _react2.default.createElement(
      'div',
      { className: 'form_elem' },
      _react2.default.createElement('input', _extends({}, input, { type: type, className: inputClass })),
...
var Designer = function (_Component) {
  ...
  _createClass(Designer, [{
    ...
    value: function componentDidMount() {
      setTimeout(function () {
        (0, _jquery2.default)('.designer').css({
          "opacity": "1"
        });
      }, 10);
    }
    ...
    value: function onSubmit(values) {
      ...
      _axios2.default.post(_config2.default.api_server + '/designer', values).then(function (result) {
    ...
    key: 'showInfo',
    value: function showInfo(success) {
      if (success) {
        (0, _jquery2.default)('.info_block').removeClass('error').addClass('success').css('display', 'flex');
        (0, _jquery2.default)('.info_msg').html('Письмо отправлено! Наш сотрудник свяжется с вами. Спасибо за проявленный интерес.');
      } else {
        (0, _jquery2.default)('.info_block').removeClass('success').addClass('error').css('display', 'flex');
        (0, _jquery2.default)('.info_msg').html('Письмо не отправлено! Пожалуйста, попробуйте еще раз.');
      }

      setTimeout(function () {
        (0, _jquery2.default)('.info_block').css('display', 'none');
      }, 4000);
    }
  }, {
    key: 'hidePopup',
    value: function hidePopup() {
      (0, _jquery2.default)('.designer_popup').removeClass('opened');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'designer wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0412\u044B\u0437\u0432\u0430\u0442\u044C \u0414\u0438\u0437\u0430\u0439\u043D\u0435\u0440\u0430'
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('span', { className: 'info_msg' })
        ),
        _react2.default.createElement(
          'form',
          { className: 'designer_form', onSubmit: handleSubmit(this.onSubmit.bind(this)) },
          ...
          _react2.default.createElement(
            'div',
            { className: 'form_item addInfo' },
            _react2.default.createElement(
              'label',
              null,
              '\u0412\u0430\u0448\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435:'
            ),
            _react2.default.createElement(_reduxForm.Field, { name: 'add_info', component: 'textarea' })
          ),
          _react2.default.createElement(
            'button',
            { type: 'submit', className: invalid ? 'btn_disable' : '' },
            '\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C'
          )
        )
      );
...
var _designer = __webpack_require__(144);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { to: '/', className: 'back_btn' },
          _react2.default.createElement('i', { className: 'fa fa-angle-left', 'aria-hidden': 'true' }),
          '\u041D\u0430\u0437\u0430\u0434'
        ),
        _react2.default.createElement(
          'form',
          { className: 'login_form', onSubmit: handleSubmit(this.onSubmit.bind(this)) },
          this.props.error && _react2.default.createElement(
            'span',
            null,
            '\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u043B\u043E\u0433\u0438\u043D \u0438/\u0438\u043B\u0438 \u043F\u0430\u0440\u043E\u043B\u044C'
          ),
          _react2.default.createElement(_reduxForm.Field, { name: 'login', className: 'login', type: 'text', component: _designer.renderField, label: '\u041B\u043E\u0433\u0438\u043D:' }),
          _react2.default.createElement(_reduxForm.Field, { name: 'password', className: 'password', type: 'password', component: _designer.renderField, label: '\u041F\u0430\u0440\u043E\u043B\u044C:' }),
          _react2.default.createElement(
            'button',
            { type: 'submit', className: 'login_btn' },
            '\u0412\u043E\u0439\u0442\u0438'
          )
        )
      );
...
Login = (0, _reactRedux.connect)(mapStateToProps, { authUser: _index.authUser })(Login);
...
var _reduxPromise = __webpack_require__(194);
...
if (localStorage.jakkardUserInfo) {
  store.dispatch((0, _index.fromLocalStorage)(localStorage.jakkardUserInfo));
}
...
function deleteImages(id) {
  var url = _config2.default.api_server + 'photos/' + id;
  var request = _axios2.default.delete(url);

  return {
    type: _types.DELETE_IMAGES,
    payload: request
  };
}

function authUser(credentials) {
  var url = _config2.default.api_server + 'login';
  var request = _axios2.default.post(url, credentials);
...
function fromLocalStorage(user) {
  var userObj = JSON.parse(user);
  var url = _config2.default.api_server + 'checktoken';
  var request = _axios2.default.post(url, { user: userObj });
  return {
    type: _types.LOCALSTORAGE_USER,
    payload: request
  };
}
...
var _fluxStandardAction = __webpack_require__(195);
...
var _lodashIsplainobject = __webpack_require__(196);
...
var _active_reducer = __webpack_require__(201);

var _active_reducer2 = _interopRequireDefault(_active_reducer);

var _photos_reducer = __webpack_require__(202);

var _photos_reducer2 = _interopRequireDefault(_photos_reducer);

var _user_reducer = __webpack_require__(203);
...
var DELETE_IMAGES = exports.DELETE_IMAGES = 'DELETE_IMAGES';
var AUTH_USER = exports.AUTH_USER = 'AUTH_USER';
var LOCALSTORAGE_USER = exports.LOCALSTORAGE_USER = 'LOCALSTORAGE_USER';
...
var _admin = __webpack_require__(407);

var _admin2 = _interopRequireDefault(_admin);

var _add_photo = __webpack_require__(408);

var _add_photo2 = _interopRequireDefault(_add_photo);
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouterDom.Route, { path: '/addphoto', component: _add_photo2.default })
);
...
var _works = __webpack_require__(389);

var _works2 = _interopRequireDefault(_works);

var _contacts_short = __webpack_require__(390);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { to: '/contacts', onClick: function onClick() {
                return _this2.props.setActive('contacts');
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { href: 'https://vk.com/club124645374', target: '_blank' },
              _react2.default.createElement('span', { className: 'fa fa-vk', 'aria-hidden': 'true' })
            ),
            _react2.default.createElement(
              'a',
              { href: 'https://www.instagram.com/salon_jakkard/', target: '_blank' },
              _react2.default.createElement('span', { className: 'fa fa-instagram', 'aria-hidden': 'true' })
            ),
            _react2.default.createElement(
              'a',
              { href: 'https://www.ok.ru/profile/556242223180', target: '_blank' },
              _react2.default.createElement('span', { className: 'fa fa-odnoklassniki', 'aria-hidden': 'true' })
            )
          )
        ),
...
exports.default = (0, _reactRedux.connect)(null, { setActive: _index.setActive })(Main);
...
var _img_container = __webpack_require__(8);
...
var _services = __webpack_require__(394);
...
var LivingRoom = function (_Component) {
  ...
  _createClass(LivingRoom, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'livingroom wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0413\u043E\u0441\u0442\u0438\u043D\u0430\u044F'
...
var DiningRoom = function (_Component) {
  ...
  _createClass(DiningRoom, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'diningroom wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0421\u0442\u043E\u043B\u043E\u0432\u0430\u044F'
...
var BedRoom = function (_Component) {
  ...
  _createClass(BedRoom, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'bedroom wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0421\u043F\u0430\u043B\u044C\u043D\u044F'
...
var ChildRoom = function (_Component) {
  ...
  _createClass(ChildRoom, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'childroom wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0414\u0435\u0442\u0441\u043A\u0430\u044F'
...
var Cabinet = function (_Component) {
  ...
  _createClass(Cabinet, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'cabinet wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041A\u0430\u0431\u0438\u043D\u0435\u0442'
...
var Ladder = function (_Component) {
  ...
  _createClass(Ladder, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'ladder wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041B\u0435\u0441\u0442\u043D\u0438\u0447\u043D\u044B\u0435 \u041F\u0440\u043E\u043B\u0435\u0442\u044B'
...
var Corp = function (_Component) {
  ...
  _createClass(Corp, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'corp wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041A\u043E\u0440\u043F\u043E\u0440\u0430\u0442\u0438\u0432\u043D\u044B\u0435'
...
var Interior = function (_Component) {
  ...
  _createClass(Interior, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'interior wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B \u0418\u043D\u0442\u0435\u0440\u044C\u0435\u0440\u0430'
...
var Accessories = function (_Component) {
  ...
  _createClass(Accessories, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'accessories wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u0410\u043A\u0441\u0435\u0441\u0441\u0443\u0430\u0440\u044B'
...
var Accessories = function (_Component) {
  ...
  _createClass(Accessories, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'cornices wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041A\u0430\u0440\u043D\u0438\u0437\u044B'
...
var Textile = function (_Component) {
  ...
  _createClass(Textile, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'textile wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u041A\u0430\u0442\u0430\u043B\u043E\u0433 \u0442\u043A\u0430\u043D\u0435\u0439'
...
var Sketches = function (_Component) {
  ...
  _createClass(Sketches, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { id: 'scroll', className: 'sketches wrapper' },
        _react2.default.createElement(
          'h3',
          null,
          '\u042D\u0441\u043A\u0438\u0437\u044B'
...
var Admin = function (_Component) {
  ...
  function Admin(props) {
    ...
    _this.state = { type: 'general', header: 'Главная' };
    return _this;
  }
  ...
  _createClass(Admin, [{
    ...
    value: function logout() {
      var url = _config2.default.api_server + 'logout';
      var token = JSON.parse(localStorage.jakkardUserInfo).jwtToken;
      _axios2.default.post(url, { token: token });
      this.props.logout();
      location.reload();
    }
  }, {
    key: 'onMenuItemSelect',
    value: function onMenuItemSelect(e, type) {
      this.setState({ type: type, header: (0, _jquery2.default)(e.target).html() });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      if (!this.props.isAuthenticated) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/addphoto', className: 'add_btn' },
            '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0444\u043E\u0442\u043E'
          ),
          _react2.default.createElement(
            'button',
            { onClick: this.logout.bind(this), className: 'logout_btn' },
            '\u0412\u044B\u0439\u0442\u0438'
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'general');
              } },
            '\u0413\u043B\u0430\u0432\u043D\u0430\u044F'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'livingroom');
              } },
            '\u0413\u043E\u0441\u0442\u0438\u043D\u0430\u044F'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'diningroom');
              } },
            '\u0421\u0442\u043E\u043B\u043E\u0432\u0430\u044F'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'bedroom');
              } },
            '\u0421\u043F\u0430\u043B\u044C\u043D\u044F'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'childroom');
              } },
            '\u0414\u0435\u0442\u0441\u043A\u0430\u044F'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'cabinet');
              } },
            '\u041A\u0430\u0431\u0438\u043D\u0435\u0442'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'ladder');
              } },
            '\u041B\u0435\u0441\u0442\u043D\u0438\u0447\u043D\u044B\u0435 \u041F\u0440\u043E\u043B\u0435\u0442\u044B'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'corp');
              } },
            '\u041A\u043E\u0440\u043F\u043E\u0440\u0430\u0442\u0438\u0432\u043D\u044B\u0435'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'interior');
              } },
            '\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B \u0418\u043D\u0442\u0435\u0440\u044C\u0435\u0440\u0430'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'accessories');
              } },
            '\u0410\u043A\u0441\u0435\u0441\u0441\u0443\u0430\u0440\u044B'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'cornices');
              } },
            '\u041A\u0430\u0440\u043D\u0438\u0437\u044B'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'textile');
              } },
            '\u041A\u0430\u0442\u0430\u043B\u043E\u0433 \u0422\u043A\u0430\u043D\u0435\u0439'
          ),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this2.onMenuItemSelect(e, 'sketches');
              } },
            '\u042D\u0441\u043A\u0438\u0437\u044B'
          )
        ),
        _react2.default.createElement(
          ...
          _react2.default.createElement('hr', null),
          _react2.default.createElement(_img_container2.default, { type: this.state.type, admin: true })
        )
      );
    }
  }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { logout: _index.logoutUser })(Admin);
...
var AddPhoto = function (_Component) {
  _inherits(AddPhoto, _Component);

  function AddPhoto() {
    _classCallCheck(this, AddPhoto);

    return _possibleConstructorReturn(this, (AddPhoto.__proto__ || Object.getPrototypeOf(AddPhoto)).apply(this, arguments));
  }

  _createClass(AddPhoto, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      if ((0, _jquery2.default)('.add_photo').length) {
        (0, _jquery2.default)('.file_select').change(function (e) {
          var input = (0, _jquery2.default)('.file_select');
          var fileName = void 0;
          ...
          (0, _jquery2.default)('#file_label').html(fileName);
        });
      }
    }
  }, {
    ...
    key: 'render',
    value: function render() {
      var uploadPage = void 0;
      if (this.props.isAuthenticated) {
        uploadPage = _react2.default.createElement(
          'div',
          { className: 'add_photo' },
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/admin', className: 'back_btn' },
            _react2.default.createElement('i', { className: 'fa fa-angle-left', 'aria-hidden': 'true' }),
            '\u041D\u0430\u0437\u0430\u0434'
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { className: 'file_select',
              type: 'file',
              id: 'file',
              name: 'sampleFile',
            ...
            _react2.default.createElement(
              'label',
              { id: 'file_label', htmlFor: 'file' },
              '\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0444\u0430\u0439\u043B\u044B'
            ),
            _react2.default.createElement(
              'select',
              { name: 'selType', id: 'softflow' },
              _react2.default.createElement(
                'option',
                null,
                'accessories'
            ...
            _react2.default.createElement('input', { type: 'submit', id: 'upload_btn', value: '\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C' })
          )
        );
      } else {
        uploadPage = _react2.default.createElement(_login2.default, null);
      }
      return uploadPage;
    }
  }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(AddPhoto);
...
var _navbar = __webpack_require__(410);
  ...
  _createClass(Navbar, [{
    ...
    value: function navPageSelect(page) {
      (0, _jquery2.default)('html, body').animate({
        scrollTop: (0, _jquery2.default)("#scroll").offset().top
      }, 1000);
    ...
    value: function onClickXS() {
      ...
      var menu = (0, _jquery2.default)('.nav li').not('.logo');
      menu.stop().slideToggle('slow');
    }
  }, {
    key: 'onCatClick',
    value: function onCatClick() {
      if (window.innerWidth > 560) return;

      var submenu = (0, _jquery2.default)('.catalog .submenu');
      submenu.stop().slideToggle('slow');

      (0, _jquery2.default)('.work_examples .submenu').css('display', 'none');
    }
  }, {
    key: 'onWorkClick',
    value: function onWorkClick() {
      if (window.innerWidth > 560) return;

      var submenu = (0, _jquery2.default)('.work_examples .submenu');
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { onClick: function onClick(e) {
                  e.preventDefault();_this2.onCatClick();
                } },
              '\u041A\u0430\u0442\u0430\u043B\u043E\u0433'
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { onClick: function onClick(e) {
                      e.preventDefault();_this2.onWorkClick();
                    } },
                  '\u041D\u0430\u0448\u0438 \u0420\u0430\u0431\u043E\u0442\u044B'
                ),
                _react2.default.createElement(
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'p',
            null,
            'Created by Rocket Soft'
          ),
          _react2.default.createElement(
            'a',
            { href: 'https://www.facebook.com/rocketsoftt', target: '_blank' },
            'fb.com/rocketsoftt'
          )
        )
      );
  ...
  _createClass(ImgContainer, [{
    ...
    value: function componentDidMount() {
      setTimeout(function () {
        ...
        (0, _jquery2.default)('.img_items').css('display', 'flex');
      }, 1000);
    }
  }, {
    ...
    value: function componentDidUpdate() {
      ...
      (0, _jquery2.default)('.img_items').css('display', 'none');
      setTimeout(function () {
        (0, _jquery2.default)('.loading').css('display', 'none');
        (0, _jquery2.default)('.img_items').css('display', 'flex');
      }, 1000);
    ...
    key: 'onDeleteClick',
    value: function onDeleteClick(e, id) {
      var confirm = window.confirm("Вы уверены, что хотите удалить фото?");
    ...
    value: function onImgClick(e) {
      ...
      if ((0, _jquery2.default)(e.target)[0].tagName == "SPAN") {
        return;
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.photos.map(function (photo) {
            return _this3.renderImage(photo);
          })
        )
      );
    }
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { getImages: _index.getImages, deleteImages: _index.deleteImages })(ImgContainer);
